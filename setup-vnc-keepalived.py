...
class SetupVncKeepalived(object):
    ...
    def _parse_args(self, args_str):
        '''
        Eg. python setup-vnc-keepalived.py --self_ip 10.1.5.11
                   --openstack_index 1 --openstack_vip 10.1.5.13
        '''
        ...
        parser.add_argument("--openstack_vip", help = "Virtual IPP Addresses of HA Openstack nodes"),
